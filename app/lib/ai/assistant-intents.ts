...
const SIGNALS: Signal[] = [
  ...
  { intent: "dietary_accommodation", weight: 5, test: (t) => has(t, /\b(puree|pur[eé]e|chewing difficulty|soft(?:er)? food|level 4|iddsi|renal|gluten[- ]free|severe .* allergy|shellfish allergy|therapeutic diet)\b/i) },
