...
const SIGNALS: Signal[] = [
  ...
  { intent: "equipment_troubleshooting", weight: 8, test: (t) => has(t, /\b(not cooling|not heating|won'?t start|stopped working|broken|repair|diagnose|tripping breaker|warm freezer|not holding temp|high[- ]limit|work live|bypass)\b/i) },
