...
const ID_PATTERN = /^sgo:(opportunity|package|claim|asset|variant|approval|destination|publication|evidence-request|claim-evidence|research-run|research-candidate):[a-z0-9]+(?:-[a-z0-9]+)*$/;
